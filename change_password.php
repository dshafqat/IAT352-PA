...
<head>
	...
	<form action="sign-in.php" method="post">
		<fieldset>
			<legend><span class="number"> Change Password</legend>

			

				<input type="password" name="Old Password" placeholder="Enter Old Password *" value="<?php  $password;?>">
				<input type="password" name="New Password" placeholder="Enter New Password *" value="<?php  $password;?>">
